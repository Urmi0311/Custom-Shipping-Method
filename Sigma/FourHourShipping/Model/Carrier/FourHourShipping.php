...
namespace Sigma\FourHourShipping\Model\Carrier;
...
class FourHourShipping extends AbstractCarrier implements CarrierInterface
{

    /**
     * @var string
     */
    protected $_code = 'fourhourshipping';
